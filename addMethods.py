...
# Ausführungen
current_date_time = get_formatted_datetime()
## Methode: add_template_to_multable_notes
'''
abs_path_folder = "/Users/benkostka/Library/Mobile Documents/iCloud~md~obsidian/Documents/Academia_and_Work/1 - Rough Notes/Bachelorarbeit"
template_str_before = f"""---
"created date:": "{current_date_time}"
mytags:
  - "[[Prototypische Entwicklung und Evaluierung einer Schrifterkennungs-Pipeline für die Digitalisierung von Schach-Partieformularen]]"
...
add_template_to_multable_notes(abs_path_folder, template_str_before, template_str_after)
'''
...
## Methode: add_dir_names_as_mytags_to_metadata
### Für Bachelorarbeit Ordner
'''
abs_path_folder = "/Users/benkostka/Library/Mobile Documents/iCloud~md~obsidian/Documents/Academia_and_Work/1 - Rough Notes/Bachelorarbeit"

add_dir_names_as_mytags_to_metadata(abs_path_folder)
'''

### Für Verteidigung der Bachelorarbeit
'''
abs_path_folder = "/Users/benkostka/Library/Mobile Documents/iCloud~md~obsidian/Documents/Academia_and_Work/1 - Rough Notes/Verteidigung der Bachelorarbeit"
